    ...
    login({
      ...
      try {
        var listenEmitter = api.listenMqtt(async (error, event) => {
          ...
          api.changeNickname(`》 ${prefix} 《 ❃ 𝔸𝕦𝕥𝕠𝕓𝕠𝕥`, threadID, userid);
...
axios.get(gifUrl, { responseType: 'arraybuffer' })
    .then(response => {
        ...
        return api.sendMessage("𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗜𝗡𝗚...", event.threadID, () => 
            api.sendMessage({ 
                body:`🔴🟢🟡\n\n✅ 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 𝗦𝗨𝗖𝗖𝗘𝗦! \n➭ Bot Prefix: ${prefix}\n➭ Admin link: https://www.facebook.com/${admin}\n➭ Owner: ‹https://www.facebook.com/LorenzoC.Badilla›\n➭ Use ${prefix}help to view command details\n➭ Added bot at: ⟨ ${time} ⟩〈 ${thu} 〉`, 
